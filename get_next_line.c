...
/*   Updated: 2019/06/03 16:46:38 by eovertoo      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

int		ft_result(char **str, char *tmp, char **line, int fd)
{
	unsigned int			i;
	size_t					len;
...
int		read_and_save(char **str, char *buf, int fd, char **tmp)
{
	if (str[fd] == NULL)
	{
		str[fd] = ft_strnew(0);
